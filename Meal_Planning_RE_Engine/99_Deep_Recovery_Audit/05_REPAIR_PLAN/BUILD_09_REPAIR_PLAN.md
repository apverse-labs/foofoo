# BUILD_09_REPAIR_PLAN — Admin/data operations

**Source to re-read before any repair:** DOC-22/27/28 (+ workbook), `CANONICAL_REQUIREMENTS_LEDGER`, `CANONICAL_ALGORITHM_LEDGER`, traceability matrix.

**Plan:** FORWARD BUILD (LOW, P3): Admin CMS UI screens. QA-check logic + governance semver present; column bugs fixed (PACK 9).
